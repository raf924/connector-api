...
class UserEvent extends $pb.ProtobufEnum {
  static const UserEvent JOINED = UserEvent._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'JOINED');
  static const UserEvent LEFT = UserEvent._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'LEFT');
